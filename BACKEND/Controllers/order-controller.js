...
exports.addOrder = (req, res) => {
    ...
    const newOrder = new Order({ CustomerName, ProductName, quantity, orderDate, status });
...
exports.updateOrder = async (req, res) => {
    ...
    const update = await Order.findByIdAndUpdate(oderId, updateOrder).then(() => {
...
exports.deleteOrder = async (req, res) => {
    ...
    const orderUp = await Order.findByIdAndDelete(orderId).then(() => {
