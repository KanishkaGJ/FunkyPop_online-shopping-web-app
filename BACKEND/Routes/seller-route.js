...
const { slrsignup, verifyToken, getSeller, slrlogin} = require('../Controllers/seller-auth-controller');
const { updateSeller, deleteSeller } = require('../Controllers/seller-controller');
